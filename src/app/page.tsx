    ...
    return (
        <>
            ...
            <section className="flex flex-col items-center justify-center text-center py-20 px-4 bg-gradient-to-r from-blue-900 via-purple-900 to-indigo-900 text-white">
                <h1 className="text-4xl md:text-6xl font-extrabold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                    InterviewVault
                </h1>
                ...
                <p className="text-lg md:text-xl max-w-3xl mb-8 text-gray-300">
                    Connect with thousands of aspirants by sharing your UPSC, SSB, and other competitive exam interview experiences. 
                    Learn from real stories and prepare better for your dream career.
                </p>
                <div className="flex flex-col sm:flex-row gap-4">
                    <a href="/share-experience" className="bg-gradient-to-r from-blue-500 to-purple-600 px-8 py-4 rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-lg">
                        Share Your Experience
                    </a>
                    <a href="/browse" className="border-2 border-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-all duration-300">
                        Browse Experiences
                    </a>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <a href="/browse?category=upsc" className="text-blue-600 font-medium hover:text-blue-800">
                                View Experiences →
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <a href="/browse?category=ssb" className="text-green-600 font-medium hover:text-green-800">
                                View Experiences →
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <a href="/browse?category=banking" className="text-purple-600 font-medium hover:text-purple-800">
                                View Experiences →
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <a href="/browse?category=engineering" className="text-orange-600 font-medium hover:text-orange-800">
                                View Experiences →
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <a href="/browse?category=defense" className="text-red-600 font-medium hover:text-red-800">
                                View Experiences →
                            </a>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                            ...
                            <a href="/browse?category=academic" className="text-indigo-600 font-medium hover:text-indigo-800">
                                View Experiences →
                            </a>
                        </div>
                    </div>
