...
import { MoreHorizontal, Edit, Trash2, View, CheckCircle, EyeOff } from "lucide-react";

interface ActionsProps {
    onEdit: () => void;
    onDelete: () => void;
    onView: () => void;
    handleApproveExp: () => void;
    handleHideExp: () => void;
}

export default function Actions({ onEdit, onDelete, onView, handleApproveExp, handleHideExp }: ActionsProps) {
