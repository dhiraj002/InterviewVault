        ...
        <footer className="bg-[#0d1117] border-t border-gray-800 py-12">
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div>
                    ...
                    {/* Socials */}
                    <div className="flex space-x-4 mt-4">
                        <Link href="https://linkedin.com/in/dhiraj-dhiman02" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                            <FaLinkedin className="w-5 h-5" />
                        </Link>
                        <Link href="https://github.com/dhiraj002" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-gray-400 hover:text-blue-400 transition-colors duration-200">
                            <FaGithub className="w-5 h-5" />
                        </Link>
                    </div>
                </div>
            ...
            {/* Bottom Section */}
            <div className="mt-10 border-t border-gray-800 pt-4 text-center space-y-3">
                <p className="text-gray-500 text-xs">© {new Date().getFullYear()} InterviewVault. All rights reserved.</p>
                <div className="text-xs text-gray-400 space-x-3">
                    <Link href="/terms&conditions" className="text-blue-400 hover:text-blue-300 transition underline">
                        Terms & Conditions
                    </Link>
                    <span>|</span>
                    <Link href="/privacy-policy" className="text-blue-400 hover:text-blue-300 transition underline">
                        Privacy Policy
                    </Link>
                </div>
            </div>
